...
export async function POST(req: NextRequest) {
  // Don't record traffic from a logged-in admin (operator browsing the site) —
  // their visits shouldn't pollute the visitor stats.
  ...
  // Stamp the logged-in user's email when a session exists. This is what turns
  // an anonymous homepage visitor into an identified user in the dashboard;
  // the shared sessionId stitches their pre-login and post-login rows together.
