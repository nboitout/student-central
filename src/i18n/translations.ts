  ...
  de: {
    ...
    problem: {
      ...
      cards: [
        {
          num: "01",
          title: "Richtig bedeutet nicht immer verstanden",
          body: "Studierende können die korrekte Option aus falschen Gründen wählen.",
        },
        {
          num: "02",
          title: "Falsch bedeutet nicht immer verloren",
          body: "Manche falschen Antworten zeigen ein Teilverständnis, das sich weiterentwickeln lässt.",
        },
        {
          num: "03",
          title: "Lehrende brauchen mehr als einen Score",
          body: "Um effektiv zu unterrichten, müssen Lehrende Fehlvorstellungen erkennen, nicht nur Ergebnisse.",
        },
      ],
    },
    approach: {
    ...
    pedagogy: {
      ...
      headline: "Bessere Prüfung, besseres Feedback, bessere LehrEntscheidungen",
      cols: [
    ...
    footer: {
      ...
      name:    "Nicolas Boitout",
      rest:    "und einem deutsch-französisch-rumänischen Team mit Leidenschaft für Bildung",
      copy:    "© 2025 Student Central",
    },
    workspace: {
